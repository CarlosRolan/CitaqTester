...
//			initInputStream();
    ...
    private void initView(){
        ...
        btn_DisableBuzzer = (Button) findViewById(R.id.btn_disableBuzzer_1);
    ...
    OnClickListener SendPrintListener = new OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            mCurrentBt = v.getId();
            switch(mCurrentBt){
                case 1000007://R.id.btn_opencash:
                    printerWrite(Command.openCash);
                    break;
                case 1000006://R.id.btn_cutPaper:
                    printerWrite(Command.cutPaper);
                    break;
                case 1000000://R.id.btn_getprintstatus:
                    printerWrite(Command.printStatus);
                    break;
                case 1000027://R.id.btn_printtest:
                    printerWrite(Command.printTest);
                    break;
                case 1000025://R.id.btn_printdemo:
                    printerWrite(Command.getPrintDemo());
                    break;

                case 1000028://R.id.btn_openPicture:
                    mBitmap = null;
                    /*if(OpenFileDialog.isDialogCreate && OpenFileDialog.FileSelectView.getCurrentPath().equals(OpenFileDialog.sRoot)){
                    ...
                    break;
                case 1000004://R.id.btn_printPicture:
                    if(mBitmap != null)
                    {
                ...
                case 1000026://R.id.btn_setResidentCharacterSet:
                    ...
                    break;
                case 1000008://R.id.btn_setPrintDensity:
